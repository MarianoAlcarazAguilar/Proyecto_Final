...
drop table dato_no_ingresado cascade;
...
drop table perfil_usuario_permiso cascade;
drop table permisos cascade;
drop table razones cascade;
drop table razones_ec cascade;
drop table redes cascade;
drop table respuesta_situacion_sm cascade;
drop table respuestas_e_commerce cascade;
drop table respuestas_situaciones_ec cascade;
...
drop table social_media_redes cascade;
